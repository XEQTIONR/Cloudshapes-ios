...
-(void) uploadPhoto:(UIImage *)image
{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:@"http://localhost/scripts/uploadinsert3.php"]];
    // previously http://ec2-54-173-125-187.compute-1.amazonaws.com
    //previously uploadinsert.php uploadtest10.php
